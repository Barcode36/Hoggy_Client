 ...
 * @author Fallou
 */
public class AccueilSecretaireVaccination implements Initializable {
...
if(s!=null)
{
    try {
        ...
        Carnet  m= stub.findcarnet(s.getMatricule());
        System.out.println("hello"+m.getMatricule());
                    BufferedImage img = null;
  ...
  IConsultation stub = ( IConsultation) Naming.lookup("rmi://localhost:1099/consultation");
          ...
          ll = stub.listCarnet();
            ...
            ll.forEach((ad) -> {
                ...
                s.setDocteur(ad.getIddocteur().getNom()+" "+ad.getIddocteur().getPrenom());
                data.add(s);
                table.setItems(data);
            });
