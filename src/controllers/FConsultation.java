 ...
 * @author Fallou
 */
public class FConsultation implements Initializable {
String mois;
     @FXML
    private Label today;
  ...
  java.util.Calendar time = java.util.Calendar.getInstance();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        telephonetbx.setText("770000000");
            ...
            matriculetbx.setText("C"+String.valueOf(n));
            mois=mois();
        try {
